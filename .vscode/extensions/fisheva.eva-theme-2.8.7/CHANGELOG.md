...
```Syntax
meta.function-call.arguments: #E06C75/#CD6069
punctuation.section.brackets.double.begin,punctuation.section.brackets.double.end: #838FA7/#5D5D5FD8
keyword.accessor.dollar: #56B7C3/#00BEC4
```

* Change All Syntax

```Syntax
source.css meta.selector.css: #98C379/#00bec4 → #8E99B1/#8E8E90
```
...
storage.type.byte: #FF6AB3/#EF8ED8
support.variable.magic: #FF9070/#FF6D12
...
```UI
diffEditor.insertedTextBackground: #4EC1503F → #4EC15033
```
...
```UI
terminal.ansiBrightBlue: #437aed → #4d91f8
```

* Add All UI

```UI
banner.background: #598defe6/#0065ffa8
banner.foreground: #fff/#fff
banner.iconForeground: #fff/#fff
```
...
```UI
commandCenter.activeBackground: #598DEFE6/#0065FFA8 → #598def72/#0065ff3f
commandCenter.activeForeground: #fff/#fff → #E1E4EA/#535355
```

2.1.5~2.1.6 (2023-09-20)
