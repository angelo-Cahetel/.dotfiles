...
const tag_names_1 = require("./helpers/tag-names");
/** HTML token type. */
var HTMLTokenType;
...
class WhiteListHTMLTokenScanner extends HTMLTokenScanner {
    ...
    scanForWhiteList() {
        ...
        for (let token of scanner.parseToTokens()) {
            ...
            let tagName = token.type === HTMLTokenType.SelfCloseTagEnd ? currentTagName : token.text;
            if (tag_names_1.DOMElementNames.has(tagName)) {
