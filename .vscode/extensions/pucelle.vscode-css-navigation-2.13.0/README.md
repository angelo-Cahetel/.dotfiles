...
![code-lens-definition](https://github.com/pucelle/vscode-css-navigation/raw/HEAD/images/code-lens-definition.jpg)

- Set `enableReferenceCodeLens` option to `true` to enable reference code lens.
![code-lens-reference](https://github.com/pucelle/vscode-css-navigation/raw/HEAD/images/code-lens-reference.jpg)
...
![class-name-definition-diagnostic](https://github.com/pucelle/vscode-css-navigation/raw/HEAD/images/class-name-definition-diagnostic.jpg)

- Set `enableClassNameReferenceDiagnostic` option to `true` to enable reference diagnostic.
![class-name-reference-diagnostic](https://github.com/pucelle/vscode-css-navigation/raw/HEAD/images/class-name-reference-diagnostic.jpg)
...
![css-variable](https://github.com/pucelle/vscode-css-navigation/raw/HEAD/images/css-variable.gif)
...
![hover](https://github.com/pucelle/vscode-css-navigation/raw/HEAD/images/hover.jpg)
