...
- For [#116](https://github.com/pucelle/vscode-css-navigation/issues/116), support `@css-ignore` in a css comment to ignore diagnostic.
- For [#124](https://github.com/pucelle/vscode-css-navigation/issues/124), when self close tag includes anonymous callback as attribute.
- For [#122](https://github.com/pucelle/vscode-css-navigation/issues/122), support `xxxClassNameXXX = 'classes'`, `xxx_class_name_xx`, and `{xxxClassNameXXX: 'classes'}`.


## [2.11.3]

- Fix [#123](https://github.com/pucelle/vscode-css-navigation/issues/123), when React JSX code includes RegExp.
...
- Fix for [#120](https://github.com/pucelle/vscode-css-navigation/issues/120), scenario when react element syntax contains comments.


## [2.11.0]

- Add a class name token scanner for complex class-names embedded in `className=...`, `:class=...`...
- Fix [#116](https://github.com/pucelle/vscode-css-navigation/issues/116), partial of [#120](https://github.com/pucelle/vscode-css-navigation/issues/120). 


## [2.10.0]

- Rename option `enableIdAndClassNameCompletion` to `enableCompletions`.
- Add option `enablesCustomTagCompletion`, to fix [#119](https://github.com/pucelle/vscode-css-navigation/issues/119).
- Fixes [#116](https://github.com/pucelle/vscode-css-navigation/issues/116), [#117](https://github.com/pucelle/vscode-css-navigation/issues/117). 
...
- Fixes [#114](https://github.com/pucelle/vscode-css-navigation/issues/114), supports more react class module syntax, otherwise support definition code-lens for css module.
...
- For [#112](https://github.com/pucelle/vscode-css-navigation/issues/112), and support escaped class name like `xl:w-1/6` in Tailwind.


## [2.8.4]

- Fix [#111](https://github.com/pucelle/vscode-css-navigation/issues/111), and will treat react imported class names `className={style.className}` as class name reference.


## [2.8.3]

- Fix a parsing issue for [#109](https://github.com/pucelle/vscode-css-navigation/issues/109).


## [2.8.2]

- Reduce bundle size.
- Fix [#109](https://github.com/pucelle/vscode-css-navigation/issues/109), resolve syntaxes like `:class="a ? 'b' : 'c'"`.
...
- For [#107](https://github.com/pucelle/vscode-css-navigation/issues/107), supports class name diagnostic.
- Change option `enableCSSVariableColor` to `enableCSSVariableColorPreview`.


## [2.5.0]

- For [#106](https://github.com/pucelle/vscode-css-navigation/issues/106), supports css variable name completion when overwriting variable value.
...
- Fix [#104](https://github.com/pucelle/vscode-css-navigation/issues/104), will not suggest for react components as a tag selector in CSS.


## [2.3.9]

- Fix [#103](https://github.com/pucelle/vscode-css-navigation/issues/103), now self-closed React Element like `<Image />` can be rightly detected.
- Fix a parsing issue when js codes contain `/`.


## [2.3.8]

- For [#102](https://github.com/pucelle/vscode-css-navigation/issues/102), When finding references, will exclude current selector from reference list.
